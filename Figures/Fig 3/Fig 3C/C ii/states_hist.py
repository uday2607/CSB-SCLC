...
if __name__ == '__main__':
    ...
    toy1 = pd.read_csv("model1.csv")
    labels = ["S{}".format(i+1) for i in range(len(toy1['State']))]
    plot(labels,toy1['Toy_Mean'],toy1['WT_Mean'],toy1["Toy_SD"],toy1["WT_SD"],'Reduced Model 1','WT')
